...
async function main() {
    const lessons = [
        {
            title: "What is money?",
            content: "Money is something we use to buy things we need and things we want. It helps us exchange value.",
        ...
        {
            title: "Saving money",
            content: "Saving means keeping some money now so you can use it later for an important goal.",
            category: "Savings",
            ageGroup: "8-12",
            quizzes: [
                {
        ...
        },
        {
            ...
            content: "A need is something important like food and school supplies. A want is something nice to have, like extra toys.",
            category: "Budgeting",
            ageGroup: "8-12",
            quizzes: [
                {
